...
export const CategoryButton = styled.button`
  ...
  padding: 10px 17px;
  border: 1px solid
    ${({ $active }) => ($active ? "#d96b2b" : "rgba(74,46,31,.1)")};
  border-radius: 999px;
  ...
  cursor: pointer;
  box-shadow: ${({ $active }) =>
    $active ? "0 8px 20px rgba(217,107,43,.25)" : "none"};
`;
...
export const DishCard = styled.article`
  ...
  &:hover {
    ...
    box-shadow: 0 16px 38px rgba(60, 34, 20, 0.12);
  }
...
export const Cart = styled.button`
  ...
  font-weight: 800;
  cursor: pointer;
  box-shadow: 0 14px 35px rgba(42, 25, 18, 0.3);
  .ant-badge-count {
    background: #f07835;
    box-shadow: 0 0 0 2px #2a1912;
  }
  @media (max-width: 650px) {
    right: 16px;
